...
/**
 * This program shows values begin stored in an array's elements and displayed.
 */
...
public class ArrayDemo1 {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the hours worked " + EMPLOYEES + " employees.");

        // Get the hours worked by employees 1.
        System.out.print("Employee 1: ");
        hours[0] = keyboard.nextInt();

        // Get the hours worked by employees 2.
        System.out.print("Employee 2: ");
        hours[1] = keyboard.nextInt();

        // Get the hours worked by employees 3.
